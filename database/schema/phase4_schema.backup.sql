...
-- Phase 3 FHIR resources are retained as JSONB evidence and projected
-- into relational tables used by the Phase 4 validation suite.
...
-- Generic relational projections for additional Phase 3 resources.
